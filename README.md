...
Options:  
  ...
  -h         show the usage.
  -i string  input base, must be 0, an integer between 2 and 62, or b58/b64.
  -o string  output base, must be 0, an integer between 2 and 62, or b58/b64.
  -s         show input on the result.

Description:
  The base argument must be 0 or a value between 2 and 62 or "b58", "b64". If the base is 0, the string prefix determines the actual conversion base. A prefix of "0x" or "0X" selects base 16; the "0" prefix selects base 8, and a "0b" or "0B" prefix selects base 2. Otherwise the selected base is 10.
...
For base58 and base64, it will convert between base58 and hex or between base64 and hex by default.
...
Example:
  ...
  nbc -i b58 3mJr7AoUXx2Wqd           //convert base58 to hex
  nbc -i b64 -o b58 SGVsbG8gd29ybGQ=  //convert base64 to base58
```
