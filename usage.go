...
func Usage() {
	...
	data := helpData{
		...
		Description: `The base argument must be 0 or a value between 2 and 62 or "b58", "b64". If the base is 0, the string prefix determines the actual conversion base. A prefix of "0x" or "0X" selects base 16; the "0" prefix selects base 8, and a "0b" or "0B" prefix selects base 2. Otherwise the selected base is 10.
